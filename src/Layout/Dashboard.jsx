...
const Dashboard = () => {
    ...
    return (
        <>
            <div className="flex relative min-w-screen min-h-screen dashboard-bg">
                ...
                {/* min-h-screen  */}
                <div className="flex-1 max-h-screen ml-16 lg:ml-60 px-3 py-10 lg:px-8 md:px-5 lg:mb-5">
