    ...
    return (
        <>
            <div className="flex relative min-h-screen dashboard-bg">
                ...
                <div className="pointer-events-none fixed inset-0 -z-20 bg-white bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_1px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_1px)] bg-[size:6rem_4rem]"></div>
