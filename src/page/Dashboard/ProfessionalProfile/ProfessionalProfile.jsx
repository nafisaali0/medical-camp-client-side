                        ...
                        <>
                            <div key={user?._id}>
                                ...
                                <div className="text-xl font-bold flex flex-wrap gap-10 my-10">
                                    ...
                                    <div>
                                        <h1>Medical Specialty: <span className="text-xl font-semibold">{user?.medicalSpecialty}</span></h1>
                                    </div>
                                </div>
                                <div className="my-10">
                                    ...
                                    <dialog id="my_modal_4" className="modal">
                                        <div className="modal-box w-11/12 max-w-5xl">
                                            ...
                                            <form onSubmit={(e) => handleSubmit((data) => onSubmit(user._id, data))(e)} className="max-w-sm mx-auto">
                                                ...
                                                <div className="mb-5">
                                                    <label htmlFor="address" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Medical Specialty</label>
                                                    <textarea type="text" {...register("medicalSpecialty")} defaultValue={user?.medicalSpecialty} placeholder="Medical Specialty" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"></textarea>
                                                </div>
                                                <div className="mb-5">
