                            ...
                            <>
                                <SwiperSlide>
                                    ...
                                    <div className="relative rounded-3xl bg-white shadow-lg hover:shadow-xl">
                                        ...
                                        <div className="w-full z-10 md:max-w-[290px] md:mx-auto md:absolute md:top-56 md:left-10 p-3 md:rounded-lg bg-gradient-to-r from-[#404f68] via-[#87A8D0]/60 to-[#B9CEEB]/60 backdrop-blur-sm">
                                            ...
                                            <div className="flex flex-col items-start gap-4 mt-7 md:mt-14">
                                                <div className="w-full space-y-3">
                                                    ...
                                                    <div className="flex items-start gap-2">
                                                        <GoPeople className="text-[22px] text-btnColor" />
                                                        <h1 className="text-sm font-normal text-textDark">
